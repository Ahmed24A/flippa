        ...
        if (request()->expectsJson()) {
            ...
            return response(
                "<div style='text-align:center'><h1>Could not access a file or folder</h1> <br> Location: <b>$path</b><br>" .
                    '<p>See the article here for possible solutions: <a target="_blank" href="https://support.codedz.com/help-center/articles/21/25/207/changing-file-permissions">https://support.codedz.com/help-center/articles/207/changing-file-permissions</a></p></div>',
            );
        }
    }
}
