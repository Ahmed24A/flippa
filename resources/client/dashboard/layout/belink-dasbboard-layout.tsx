...
import {linkdzDashboardSidenav} from './sidenav/linkdz-dashboard-sidenav';
...
export function linkdzDashboardLayout() {
  const {
    links: {dash_footer},
  } = useSettings();
  return (
    <DashboardLayout name="linkdz-dashboard" leftSidenavCanBeCompact>
      <linkdzNavbar />
      <DashboardSidenav position="left">
        <linkdzDashboardSidenav />
      </DashboardSidenav>
      <DashboardContent>
...
function linkdzNavbar(props: DashboardNavbarProps) {
